...
export class Cards extends Component {
    ...
    fetchCards = async () =>{
        try {
            ...
            let response = await axios.get('http://147.182.135.17:3000/api/users/cards', 
    ...
    addCard = async () => {
            ...
            // try posting
            let response = await axios.post('http://147.182.135.17:3000/api/users/cards/add', {cvv: this.state.cardCvv, number: this.state.cardNumber, exp:this.state.cardExp},
    ...
    changeCard = async (card) => {
        ...
        try {
            const response  = await axios.post('http://147.182.135.17:3000/api/users/cards/switch',
